...
# ╔═╡ 172a4c8f-540c-455a-b53e-767cd840dde3
begin
	using DataFrames
	using CSV
end

# ╔═╡ cc89574a-61b8-4865-b20e-67fb6a3c75cd
using Plots  # This will install plots

# ╔═╡ bb5fea24-45ea-48fa-8c38-4812e7b457d0
using PlutoUI

# ╔═╡ 444abb9c-89a6-4f09-acea-b5166764e112
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ 22e3c07e-a9b7-4f3f-af28-6c8c6ad3e2fa
df.Country_code === df[!, "Country_code"]

# ╔═╡ 9a140178-567a-4951-9f27-ffd2cc17aba8
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ daa9726a-5c34-4fcf-b925-831cbe5fa3fc
sg_data = filter(:Country_code => equals_sg, df)

# ╔═╡ 5eb5baac-5b15-4f79-bec4-817a06079809
dates = sg_data[!, "Date_reported"]

# ╔═╡ 2b6c6673-64e7-442c-863c-96390e73e926
cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ 77e7b04e-cc2f-4645-99d1-b656aa5be050
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ 89b7e43e-355e-4fd9-b051-06651a8492c6
...
# ╔═╡ d907e795-b438-4584-9d81-08d4036909bc
@bind slider_value Slider(0:10:1000)

# ╔═╡ dbf4f77e-f198-4760-b609-e203ec0e026f
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ 29807f7b-dff7-4dc7-8ee3-7eee9d903141
@bind date_slider_index Slider(1:length(dates))

# ╔═╡ 1be780a2-c1c4-4a4f-aaf4-a703e1cb599c
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ 1369e24f-fe11-4eb1-bd8d-358aa9c0b05c
...
# ╔═╡ 2e4f62f7-375e-4841-8afc-64bcb8a052a7
